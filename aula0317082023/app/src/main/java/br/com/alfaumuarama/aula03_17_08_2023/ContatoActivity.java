...
public class ContatoActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //criando um listener para executar quando clicar no botão
    ...
    private void enviar(){
        try{
            //String emailPara = "paramim@email.com.br";
            ...
            //telaEmail.putExtra("codigo",10); - variável e
            ...
            //startActivity(telaEmail); - caso eu queira colocar uma tela
